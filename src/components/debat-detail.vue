    ...
    <div class="challenge-detail">
      <div class="challenger-info">
        <div class="avatar-container">
          <img :src="challenger.avatar" :alt="challenger.username">
        </div>
  ...
  <div class="debat-detail">
    ...
    <div v-if="withOpponent" class="detail-lawan">
      ...
      <div class="meta">
        ...
        <div class="user-data">
          <div class="name">Ratu Cebongan</div>
    ...
    <div class="time-saldo">
      ...
      <div class="saldo-value">
        <i class="icon icon-hourglass"></i> <b>120</b>&nbsp;menit
      </div>
    </div>
  </div>
...
export default {
  ...
  methods: {
    ...
    copy() {
      ...
      const url = cleanURL(`${process.env.SHARE_DOMAIN}/share/tanya/${this.debat.id}`)
      this.$clipboard(url)
