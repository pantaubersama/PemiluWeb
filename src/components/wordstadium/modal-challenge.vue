...
<script>
import { CloseIcon, SearchIcon, WordColored, TwitterIcon } from '@/svg/icons'
import { ChallengeIllustration } from '@/svg/illustrations'

export default {
  name: 'ModalKajian',
  props: {
    text: { type: String, default: 'Laporan Kamu Berhasil Dipublish' }
  },
  data() {
    return {}
  },
